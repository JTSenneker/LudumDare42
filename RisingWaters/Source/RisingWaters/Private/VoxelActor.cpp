		...
		for (int32 y = 0; y < chunkLineElements; y++) {
			for (int32 z = 0; z < chunkZElements; z++) {
				...
				if (meshIndex > 0) {
					...
					//add faces, verts, UVs and normals
					int triangle_num = 0;
					for (int i = 0; i < 6; i++) {
						...
						if (flag) {
							...
							triangle_num += 4;//add 4 verts to next triangle


							switch (i) {
							case 0:
								Vertices.Add(FVector(-halfVoxelSize + (x*voxelSize), halfVoxelSize + (y*voxelSize), halfVoxelSize + (z*voxelSize)));
								Vertices.Add(FVector(-halfVoxelSize + (x*voxelSize), -halfVoxelSize + (y*voxelSize), halfVoxelSize + (z*voxelSize)));
								Vertices.Add(FVector(halfVoxelSize + (x*voxelSize), -halfVoxelSize + (y*voxelSize), halfVoxelSize + (z*voxelSize)));
								Vertices.Add(FVector(halfVoxelSize + (x*voxelSize), halfVoxelSize + (y*voxelSize), halfVoxelSize + (z*voxelSize)));
							...
							FColor color = FColor(127, 127, 127, i);
